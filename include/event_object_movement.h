...
void MovementType_WalkInCircles(struct Sprite *);
...
u8 MovementType_WalkInCircles_Step0(struct ObjectEvent *, struct Sprite *);
u8 MovementType_WalkInCircles_Step1(struct ObjectEvent *, struct Sprite *);
