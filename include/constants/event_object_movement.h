...
#define OBJECT_EVENT_COORD_SHIFT 8
#define OBJECT_EVENT_FRAC_SHIFT 4
#define OBJECT_EVENT_HITBOX_SIZE 16
#define OBJECT_EVENT_HITBOX (OBJECT_EVENT_HITBOX_SIZE << OBJECT_EVENT_FRAC_SHIFT)
#define OBJECT_EVENT_HITBOX_HALF (OBJECT_EVENT_HITBOX >> 1)

#define COORDS_TO_GRID(x) ((x) >> OBJECT_EVENT_COORD_SHIFT)
#define GRID_TO_COORDS(x) ((x) << OBJECT_EVENT_COORD_SHIFT)
#define GRID_TO_TILE_CENTER(x) (GRID_TO_COORDS(x) + OBJECT_EVENT_HITBOX_HALF)
#define COORDS_TO_TILE_CENTER(x) (GRID_TO_COORDS(COORDS_TO_GRID(x)) + OBJECT_EVENT_HITBOX_HALF)
...
#define MOVEMENT_TYPE_WALK_IN_CIRCLES                  0x51
...
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTER_SOUTHWEST  0xB6
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTER_SOUTHEAST  0xB7
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTER_NORTHWEST  0xB8
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTER_NORTHEAST  0xB9
#define MOVEMENT_ACTION_WALK_FASTER_SOUTHWEST           0xBA
#define MOVEMENT_ACTION_WALK_FASTER_SOUTHEAST           0xBB
#define MOVEMENT_ACTION_WALK_FASTER_NORTHWEST           0xBC
#define MOVEMENT_ACTION_WALK_FASTER_NORTHEAST           0xBD
