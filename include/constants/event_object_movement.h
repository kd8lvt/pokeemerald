...
#define ANIM_BUNNY_HOPPY_BACK_WHEEL_SOUTHWEST      (ANIM_STD_COUNT + 20)
#define ANIM_BUNNY_HOPPY_BACK_WHEEL_SOUTHEAST      (ANIM_STD_COUNT + 21)
#define ANIM_BUNNY_HOPPY_BACK_WHEEL_NORTHWEST      (ANIM_STD_COUNT + 22)
#define ANIM_BUNNY_HOPPY_BACK_WHEEL_NORTHEAST      (ANIM_STD_COUNT + 23)
