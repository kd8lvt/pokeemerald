...
#define OBJECT_EVENT_COORD_SHIFT 4
#define OBJECT_EVENT_COORD_UNIT (1 << OBJECT_EVENT_COORD_SHIFT)

#define COORDS_TO_GRID(x) ((x) >> OBJECT_EVENT_COORD_SHIFT)
#define GRID_TO_COORDS(x) ((x) << OBJECT_EVENT_COORD_SHIFT)
#define GRID_TO_TILE_CENTER(x) (GRID_TO_COORDS(x) + 8)
#define COORDS_TO_TILE_CENTER(x) (GRID_TO_COORDS(COORDS_TO_GRID(x)) + 8)
